...
The project is extensively documented in Perlilog's user guide, which can be downloaded at the project's
home page, L<http://www.opencores.org/perlilog/>, or at my own:  L<http://www.billauer.co.il/perlilog.html>.
...
The Perlilog project's home page: L<http://www.opencores.org/perlilog/>
